  ...
  <body>
	...
	<div class="container">
		...
		<div class="form-wrappers">
			<form action="php/add-new-task.php" method="post">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="TaskName" placeholder="Task Name" name="task_name" required>
			  </div>
			  <div class="row">
				<div class="col-md-6">
				  <div class="form-group">
					<label for="TaskStart">Task Start</label>
					<input type="date" class="form-control" id="TaskStart" placeholder="Task Start" name="task_start" required>
				  </div>
				</div>
				<div class="col-md-6">	
				  <div class="form-group">
					<label for="TaskEnd">Task End</label>
					<input type="date" class="form-control" id="TaskEnd" placeholder="Task End" name="task_end">
				  </div>
				</div>
				</div>	
			  ...
			  <div class="form-group" id="editor">
				...
				<textarea name="task_description" class="jqte-test"></textarea>
			  </div>
